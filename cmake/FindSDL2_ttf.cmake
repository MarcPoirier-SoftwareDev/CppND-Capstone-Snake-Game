...
if(SDL2_TTF_INCLUDE_DIR)
  if(EXISTS "${SDL2_TTF_INCLUDE_DIR}/SDL2_ttf.h")
    file(STRINGS "${SDL2_TTF_INCLUDE_DIR}/SDL2_ttf.h" SDL2_TTF_VERSION_MAJOR_LINE REGEX "^#define[ \t]+SDL_TTF_MAJOR_VERSION[ \t]+[0-9]+$")
    file(STRINGS "${SDL2_TTF_INCLUDE_DIR}/SDL2_ttf.h" SDL2_TTF_VERSION_MINOR_LINE REGEX "^#define[ \t]+SDL_TTF_MINOR_VERSION[ \t]+[0-9]+$")
    file(STRINGS "${SDL2_TTF_INCLUDE_DIR}/SDL2_ttf.h" SDL2_TTF_VERSION_PATCH_LINE REGEX "^#define[ \t]+SDL_TTF_PATCHLEVEL[ \t]+[0-9]+$")
...
mark_as_advanced(SDL2_TTF_LIBRARY SDL2_TTF_LIBRARIES SDL2_TTF_INCLUDE_DIR SDL2_TTF_INCLUDE_DIRS)